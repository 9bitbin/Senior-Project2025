...
class userOnboarding {
    ...
    async submitData() {
        ...
        try {
            ...
            await saveUser(uid, this.userData);
            ...
            // Redirect to profile.html only after Firestore save is complete
...
//         document.getElementById("start-btn").addEventListener("click", async () => await this.submitData());
//     }
